...
class WSysProp(config_table.ConfigTable):
  ...
  Directive Options:
    key: String System Properties GUI menu to edit. Required.
        e.g. Advanced --> Environment Variables.
    names: String or List of subkey names. Required. e.g. Path.
    data: String or List of subkey data. Required. e.g. C:\Program Files (x86).
